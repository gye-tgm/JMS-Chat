...
\begin{center}
  \begin{description}
    \item[Konsole 1] \hfill \\ \includegraphics[width=5in]{pic/chat_user1.png}
    \item[Konsole 2] \hfill \\ \includegraphics[width=5in]{pic/chat_user2.png}
    \item[Konsole 3] \hfill  \\ \includegraphics[width=5in]{pic/chat_user3.png}
  \end{description}
\end{center}
...
\begin{center}
\begin{description}
\item[Konsole 1] \hfill \\   \includegraphics[width=6in]{pic/mail_user1.png}
\item[Konsole 2] \hfill \\   \includegraphics[width=6in]{pic/mail_user2.png}
\item[Konsole 3] \hfill \\   \includegraphics[width=6in]{pic/mail_user3.png}
\end{description}
\end{center}
